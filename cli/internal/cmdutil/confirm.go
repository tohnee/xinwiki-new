...
// retryCmd is the directly-executable retry argv (e.g. "xinwiki doc delete a b -y");
...
// retryCmd is the directly-executable retry argv (e.g. "xinwiki kb delete kb_x -y");
// pass "" when no clean retry argv is available.

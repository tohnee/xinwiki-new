...
// DefaultFormatMode is the mode used when neither --format nor XINWIKI_FORMAT
...
// FromEnv reads XINWIKI_FORMAT and applies it when Mode hasn't been set

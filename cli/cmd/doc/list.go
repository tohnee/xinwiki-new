...
// NewCmdList builds `xinwiki doc list`.
...
backend storage order is not guaranteed and varies between deployments.`,
		Example: `  xinwiki doc list                                                  # uses project link / env
  xinwiki doc list --kb a32a63ff-fb36-4874-bcaa-30f48570a694        # explicit UUID
  xinwiki doc list --kb my-kb                                       # resolved by name
  xinwiki doc list --all-pages --format json                               # walk every page`,
		Args: cobra.NoArgs,
	...
	cmdutil.SetAgentHelp(cmd, cmdutil.AgentHelp{
		...
		Examples: []string{"xinwiki doc list --format json", "xinwiki doc list --all-pages --limit 200 --format json"},
...
func runList(ctx context.Context, opts *ListOptions, fopts *cmdutil.FormatOptions, svc ListService, kbID string) error {
	...
	// storage choices. Mirrors `xinwiki kb list`.

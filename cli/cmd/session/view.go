...
// NewCmdView builds `xinwiki session view <id>`. Renders session metadata
...
--limit without --full is rejected as input.invalid_argument.`,
	...
	cmdutil.SetAgentHelp(cmd, cmdutil.AgentHelp{
		...
		Examples:      []string{"xinwiki session view sess_abc", "xinwiki session view sess_abc --full --limit 50"},

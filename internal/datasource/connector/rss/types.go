// Package rss implements the RSS/Atom data source connector for XinWiki.
//
// It syncs articles from one or more RSS/Atom/JSON feeds into a XinWiki
...
// feed cannot redirect XinWiki to internal services.
package rss

// Package notion implements the Notion data source connector for XinWiki.
//
// It syncs pages, databases, and attachments from Notion workspaces into XinWiki knowledge bases.
//
// Notion API docs:

// Package feishu implements the Feishu (飞书/Lark) data source connector for XinWiki.
//
// It syncs documents from Feishu Wiki spaces and cloud documents into XinWiki knowledge bases.
//
// Feishu API docs:

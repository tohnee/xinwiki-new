...
type Repository struct {
	client    *osapi.Client
	baseIndex string      // pre-suffix base name, e.g. "xinwiki_abcdef012345"
...
//   - storeID == ""       — env-path; no prefix, base index = "xinwiki".
...
func NewRepository(
	...
	base := types.ResolveIndexName(indexCfg, "OPENSEARCH_INDEX", "xinwiki")
	if storeID != "" {

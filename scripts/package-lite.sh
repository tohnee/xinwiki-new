...
echo ">> Building XinWiki-lite binary..."
export EDITION=lite
...
if [ -f deploy/xinwiki-lite.service ]; then
    cp deploy/xinwiki-lite.service "${DIST_DIR}/"
fi

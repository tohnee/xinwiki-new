...
以下计划以你给出的设计文档为蓝本，将 XinWiki 从 XinWiki v0.6.2 渐进式重构为企业级知识智能平台，核心目标保持为：
...
1.2 总体目标拆解
阶段	核心目标	关键闭环
Phase 0	摸清 XinWiki 现状	代码、架构、数据、RAG、安全基线
...
3. Phase 0：现状评估与技术预研
3.1 阶段目标
摸清 XinWiki v0.6.2 的真实现状，确定 XinWiki MVP 范围，避免盲目改造。
3.2 工作包拆解
WP0.1 代码结构审计
目标：

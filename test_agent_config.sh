...
echo ""
echo "MySQL:"
echo "  mysql -u root -p xinwiki -e \"SELECT id, agent_config FROM tenants WHERE id = ${TENANT_ID};\""
echo ""
echo "PostgreSQL:"
echo "  psql -U postgres -d xinwiki -c \"SELECT id, agent_config FROM tenants WHERE id = ${TENANT_ID};\""
echo ""

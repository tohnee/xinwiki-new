...
const exampleData: FAQEntryPayload[] = [
  {
    standard_question: '什么是 XinWiki？',
    answers: ['XinWiki 是一个智能知识库管理系统', '它支持多种知识库类型和导入方式'],
    similar_questions: ['XinWiki 是什么？', '介绍一下 XinWiki'],
    negative_questions: ['这不是 XinWiki', '与 XinWiki 无关'],
    tag_name: '产品介绍',
  },
  {

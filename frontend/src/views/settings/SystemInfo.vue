...
const troubleshootingDocsURL =
  'https://github.com/Tencent/XinWiki/blob/main/docs/migration-troubleshooting.md'
...
const reportIssueURL = computed(() => {
  const base = 'https://github.com/Tencent/XinWiki/issues/new'
  ...
  if (errMsg) {
    const body = [
      '### Environment',
      `- XinWiki version: ${systemInfo.value?.version || 'unknown'}`,

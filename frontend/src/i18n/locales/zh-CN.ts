export default {
  ...
  newUserGuide: {
    ...
    steps: {
      ...
      knowledge: {
        title: "创建你的知识库",
        desc: "知识库是一切的起点：上传文档、网页或 FAQ，XinWiki 会自动解析并建立索引。点击这里进入知识库。",
      },
      chat: {
        title: "发起智能对话",
  ...
  settings: {
    ...
    storage: {
      ...
      configurable: "可配置",
      pathPrefix: "路径前缀（可选）",
      pathPrefixPlaceholder: "如 xinwiki/images",
      prefixPlaceholder: "如 xinwiki",
  ...
  system: {
    ...
    retry: "重试",
    versionLabel: "应用版本",
    versionDescription: "当前应用服务（xinwiki-app）的版本号",
    frontendVersionLabel: "UI 版本",
    frontendVersionDescription: "当前 UI 界面（xinwiki-ui）的构建版本号",
  ...
  embedPublish: {
    ...
    webhookUrlDesc: "可选。访客发消息与助手回复完成时，XinWiki 会向该 HTTPS 地址 POST 事件（message_sent / message_received）。",
    webhookSecret: "Webhook 签名密钥",
    webhookSecretPlaceholder: "用于 HMAC-SHA256 签名（X-XinWiki-Signature）",

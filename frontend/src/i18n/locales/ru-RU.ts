export default {
  ...
  newUserGuide: {
    ...
    steps: {
      welcome: {
        title: 'Добро пожаловать в XinWiki',
      ...
      knowledge: {
        ...
        desc: 'С этого всё начинается: загружайте документы, веб-страницы или FAQ, и XinWiki автоматически разберёт и проиндексирует их. Нажмите здесь, чтобы открыть базы знаний.',
      },
      chat: {
  ...
  settings: {
    ...
    xinwikiCloud: {
      title: 'XinWiki Cloud',
      description: 'Настройте учётные данные APPID и APPSECRET для XinWiki Cloud. Данные используются для модельных сервисов и движка парсинга документов.',
      ...
      expired: 'Учётные данные XinWiki Cloud истекли',
      ...
      appIdLabel: 'APPID',
      appIdDesc: 'ID приложения XinWiki Cloud',
      appIdPlaceholder: 'Введите APPID',
      appSecretLabel: 'APPSECRET',
      appSecretDesc: 'Секрет приложения XinWiki Cloud',
      ...
      usageSteps: '1. Сохраните APPID и APPSECRET\n2. Добавьте chat, embedding, rerank и vlm в разделе «Облачные модели» ниже\n3. Парсинг: Настройки БЗ → Движок парсинга → XinWiki Cloud',
      fillRequired: 'Заполните APPID и APPSECRET',
      saveSuccess: 'Учётные данные сохранены',
      saveFailed: 'Не удалось сохранить данные',
      credentialConfigured: 'Учётные данные XinWikiCloud настроены.',
      credentialExpired: 'Данные истекли. Перенастройте.',
      credentialUnconfigured: 'Учётные данные XinWikiCloud не настроены. Заполните APPID и APPSECRET.',
      checkingStatus: 'Проверка статуса...',
      goToSettings: 'Перейти в настройки',
      modelHintConfigured: 'Учётные данные XinWikiCloud настроены. Поддерживаемые модели см. в',
      modelHintDocsLink: 'документации API',
      modelsSection: {
        title: 'Облачные модели',
        descReady: 'Зарегистрируйте четыре стандартные модели XinWiki Cloud для чата, поиска, реранкинга и зрения.',
    ...
    storage: {
      ...
      pathPrefixPlaceholder: 'напр. xinwiki/images',
      prefixPlaceholder: 'напр. xinwiki',
...
/example\.(net|org)/`,
  ...
  initialization: {
    title: 'Инициализация',
    welcome: 'Добро пожаловать в XinWiki',
  ...
  system: {
    ...
    versionDescription: 'Версия сервиса приложения (xinwiki-app)',
    frontendVersionLabel: 'Версия UI',
    frontendVersionDescription: 'Версия сборки UI (xinwiki-ui)',
  ...
  createChat: {
    title: 'Привет, я XinWiki — ваши знания всегда под рукой',
  ...
  kbSettings: {
    ...
    parser: {
      ...
      engines: {
        ...
        xinwikicloud: {
          name: 'XinWiki Cloud',
          desc: 'Парсинг документов через XinWiki Cloud',
        },
        markitdown: {
          name: 'MarkItDown',

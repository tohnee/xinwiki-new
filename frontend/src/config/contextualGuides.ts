...
export const GLOBAL_USER_GUIDE_KEY = 'xinwiki:new-user-guide-done:v1'
export const OPEN_NEW_USER_GUIDE_EVENT = 'xinwiki:open-new-user-guide'

export function openNewUserGuide() {
  window.dispatchEvent(new CustomEvent(OPEN_NEW_USER_GUIDE_EVENT))
}

export const KB_EDITOR_FOCUS_SECTION_EVENT = 'xinwiki:kb-editor-focus-section'
export const AGENT_EDITOR_FOCUS_SECTION_EVENT = 'xinwiki:agent-editor-focus-section'
...
export const CONTEXTUAL_GUIDE_TOURS: Record<ContextualGuideTourId, ContextualGuideTourConfig> = {
  kbList: {
    storageKey: 'xinwiki:contextual-guide-kb-list:v2',
  ...
  kbCreate: {
    storageKey: 'xinwiki:contextual-guide-kb-create:v3',
  ...
  tenantModels: {
    storageKey: 'xinwiki:contextual-guide-tenant-models:v1',
    stepI18nPrefix: 'contextualGuide.tenantModels.steps',
    openDelayMs: 500,
    steps: [],
  },
  kbDetail: {
    storageKey: 'xinwiki:contextual-guide-kb-detail:v1',
  ...
  chat: {
    storageKey: 'xinwiki:contextual-guide-chat:v1',
  ...
  agentList: {
    storageKey: 'xinwiki:contextual-guide-agent-list:v1',
  ...
  agentCreate: {
    storageKey: 'xinwiki:contextual-guide-agent-create:v1',
